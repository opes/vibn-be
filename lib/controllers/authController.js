...
// Consider moving these two lines into your `.env` file
...
module.exports = Router()
  ...
  .get('/login/callback', async (req, res, next) => {
    try {
      // The token exchange, profile fetching, and user creation
      ...
      // Consider moving the base URL (https://vibn.netlify.app/ or http://localhost:7890) to
      // your .env file
      res.redirect(
